...
_OptValueType = Tuple[Optional[Union[bool, int, str]], str]
_OptGroupOption = TypedDict(
    "_OptGroupOption",
    {
        "name": str,
...
class CheckboxInput(Input):
    ...
    def __init__(self, attrs: Optional[_OptAttrs] = ..., check_test: Optional[Callable[..., Any]] = ...) -> None: ...
...
class ChoiceWidget(Widget):
    ...
    choices: Sequence[Union[_OptValueType, Tuple[str, Sequence[_OptValueType]]]]
    def __init__(
        self,
    ...
    ) -> List[Tuple[str, List[_OptGroupOption], int]]: ...
    def create_option(
        self,
        name: str,
        value: Any,
